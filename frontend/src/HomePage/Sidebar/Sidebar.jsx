...
function Sidebar() {
    return ( 
        <div className='relative flex flex-col w-60 min-w-56 h-screen px-6 md:px-4
                bg-color_0 text-white py-6 text-lg md:text-base'>
        {/* Sidebar */}
        ...
        <div className="absolute top-0 left-[100%] w-[20px] h-[20px] bg-color_0 remain-mask-top"></div>
        <div className="absolute bottom-0 left-[100%] w-[20px] h-[20px] bg-color_0 remain-mask-bottom"></div>
        </div>
    )
}
